...
if (!empty($user['profile_photo'])) {
    $profile_photo_path = "../assets/uploads/profile/" . $user['profile_photo'];
        ...
        <div class="edit-grid">
            <div class="profile-card">
                ...
                <div class="profile-meta">
                    ...
                    <div><strong>User ID:</strong><br>#<?php echo intval($user['id']); ?></div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="input-group full">
                            ...
                            <div class="password-wrap">
                                ...
                                >
                                <span class="toggle-password" id="togglePasswordBtn">👁</span>
                            </div>
                        </div>
                    </div>
...
function toggleCourseField() {
    ...
    if (!role || !courseBox || !course) return;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (role) {
        role.addEventListener("change", toggleCourseField);
    }
